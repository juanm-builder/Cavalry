...
- Workbook, Cloud, Companion API, Advisor, microphone, and llama.cpp host services retained behind the sidecar boundary.
- Keychain/DPAPI-backed credential envelope added.
- Target-specific macOS and Windows bundle overlays added.
- Tauri CI and full-build workflows added for macOS and Windows, with a macOS-only signed release workflow.
