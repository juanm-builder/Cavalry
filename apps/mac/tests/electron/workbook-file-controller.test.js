// Protects extracted native workbook IPC behavior without launching Electron.
...
const { createWorkbookFileController } = require('../../src/main/workbook-file-controller.cjs');
