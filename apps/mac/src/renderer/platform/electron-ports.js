...
export function createElectronRendererPorts(globalObject = globalThis) {
  const browserWindow = globalObject && globalObject.window ? globalObject.window : globalObject;
  ...
  return createNullRendererPorts({
    workbookStorage: createWorkbookStorage(browserWindow && browserWindow.cavalryFiles),
    browserCache,
