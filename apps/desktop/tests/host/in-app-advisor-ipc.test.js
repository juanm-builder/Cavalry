...
} = require('../../src/host/advisor-runtime-controller.cjs');
const advisorEndpointHelpers = require('../../src/host/advisor-endpoints.cjs');
const advisorMicrophoneHelpers = require('../../src/host/advisor-microphone.cjs');

const advisorRuntime = createAdvisorRuntimeController({
  app: { getPath: () => '/tmp/cavalry-advisor-test' },
  dialog: {},
  ipcMain: { handle() {} },
...
describe('advisor voice transcription IPC helpers', () => {
  ...
  it('installs media permission handlers on a compatible host session', () => {
