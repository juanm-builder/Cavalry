...
} = require('../../src/host/cloud-auth-controller.cjs');
const { createCloudSessionStorage } = require('../../src/host/cloud-session-storage.cjs');
const {
  createCloudProfileController,
  validateProfileName
} = require('../../src/host/cloud-profile-controller.cjs');
const {
  createCloudWorkbookController,
  isRevisionConflict
} = require('../../src/host/cloud-workbook-controller.cjs');
const {
  CLOUD_IPC_CHANNELS,
...
} = require('../../src/host/deep-link.cjs');
...
describe('Cavalry Cloud main-process boundary', () => {
  ...
  // Renderer navigation and command-origin trust are enforced by Tauri capabilities and
  // the Rust host command allowlist. See tauri-boundary.test.js.
