// Persists Supabase auth state only when Cavalry can encrypt it with operating-system storage.
'use strict';
...
function createCloudSessionStorage(options = {}) {
  ...
  async function persist() {
    ...
    await fileSystem.writeFile(
      tempPath,
      JSON.stringify({ version: 1, encryption: 'cavalry-os-safe-storage-v1', values }),
